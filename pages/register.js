...
export default function Register() {
  ...
  const handleRegister = async (event) => {
    ...
    const endpoint = "http://localhost:8080/apiV1/user/register";
                ...
                <Card.Body>
                  <Form onSubmit={handleRegister}>
                    ...
                    <div className="text-center">
                      <Button className="w-full bg-gradient-to-t from-purple-500 to-purple-300 text-white p-2 rounded-md shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-lg" type="submit" size="lg">
                        สมัครสมาชิก
                      </Button>
                    </div>
                    <br></br>
